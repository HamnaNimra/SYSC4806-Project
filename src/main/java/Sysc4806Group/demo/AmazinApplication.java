...
public class AmazinApplication {
    ...
    InitializingBean sendDatabase() {
        return () -> {
            ...
            bookRepository.save(new Book("155192515x", "Harry Potter and the Half Blood Prince", "J.K. Rowling", "random publisher", "https://images.isbndb.com/covers/59/42/9781408855942.jpg", 12));
            ...
            bookRepository.save(new Book("0984782850", "Get Coding with Debugging", "Kevin Wood", "another random publisher", "https://images.isbndb.com/covers/28/57/9780984782857.jpg", 9));
